...
void dfs(vector<vector<ll>> &adj,ll node,ll parent,set<ll> &st,vector<bool> &vis)
{
...
//only v passed - mle
//vis adj passed - accepted
//v vis passed   - accepted
//v vis adj passed - accepted
//v adj passed     - accepted
