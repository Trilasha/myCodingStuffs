...
void solve()
{
    ...
    while(q--)
    {
        ...
        if(type==0)
        {
            ...
            {
                //num even
                cout<<even_sum+(even_count*num)+odd_sum<<endl;

                even_sum=even_sum+(even_count*num);
    
            }
            else
            {
                cout<<even_sum+(even_count*num)+odd_sum<<endl;
                odd_sum=even_sum+(even_count*num)+odd_sum;
                 even_sum=0;
        ...
        else
        {
            if(num%2==0)
            {
                cout<<even_sum+odd_sum+(odd_count*num)<<endl;
                odd_sum=odd_sum+(odd_count*num);
            }
            else
            {
                cout<<even_sum+odd_sum+(odd_count*num)<<endl;
                even_sum=even_sum+odd_sum+(odd_count*num);
                odd_sum=0;
