...
void solve(){
    ...
    ans=mod_add(ans,2*odd,modval);
    ll cnt=even/6;
    ans=mod_add(ans,21*cnt,modval);
    ll rem=even%6;
    //cout<<ans<<endl;
    if(rem==1)func(3);
    else if(rem==2)func(6);
    else if(rem==3)func(10);
    else if(rem==4)func(13);
    else if(rem==5)func(16);

    cout<<(ans%modval)<<endl;
