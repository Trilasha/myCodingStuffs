...
void solve()
{
    ...
    while(ind1<a && ind2<b)
    {
        ll up_val=v1[ind1].ff;
        ll up_till=v1[ind1].ss;

        ll down_val=v2[ind2].ff;
        ll down_till=v2[ind2].ss;

        if(up_val==down_val)
        {
            ans+=min(up_till,down_till);
            if(down_till>up_till)
            {
                v2[ind2].ss-=up_till;
                ind1++;
            }
            else if(down_till==up_till)
            {
                v2[ind2].ss-=up_till;
                v1[ind1].ss-=up_till;
                ind1++;
