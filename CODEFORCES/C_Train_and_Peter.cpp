...
void solve()
{
    ...
    ll chk1=0,chk2=0,chk3=0,chk4=0;

    fr(i,s.size())
    {
        if(i+one.size()<=n && s.substr(i,one.size())==one && chk1==0)
        {
            chk1=1;
            i=i+one.size()-1;
        }
        else if(i+two.size()<=n && s.substr(i,two.size())==two && chk1==1)
            chk2=1;
    }
    ...
    fr(i,s.size())
    {
        if(i+one.size()<=n && s.substr(i,one.size())==one && chk3==0)
        {
            chk3=1;
            i=i+one.size()-1;
        }
        else if(i+two.size()<=n && s.substr(i,two.size())==two && chk3==1)
            chk4=1;
    }


    cout<<((chk2==1 && chk4==1)?"both":(chk2==1)?"forward":(chk4==1)?"backward":"fantasy")<<endl;
}
