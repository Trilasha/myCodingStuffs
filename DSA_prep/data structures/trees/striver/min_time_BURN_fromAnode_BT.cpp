//bfs has to be used 
//dfs cannot be used because all the nodes present at the same level(considering the parent pointer thing also)
//will burn at the same time 


//tc--> O(N)  (bfs for parent + burning )  considering O(1) fro map(maybe logn also depends)
//sc--> O(N)
